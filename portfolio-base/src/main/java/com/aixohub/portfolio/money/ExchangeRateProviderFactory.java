...
import com.aixohub.portfolio.events.ChangeEventConstants;
import com.aixohub.portfolio.events.SecurityChangeEvent;
import com.aixohub.portfolio.model.Client;
import com.aixohub.portfolio.model.Security;
import com.aixohub.portfolio.money.impl.ChainedExchangeRateTimeSeries;
import com.aixohub.portfolio.money.impl.EmptyExchangeRateTimeSeries;
import com.aixohub.portfolio.money.impl.InverseExchangeRateTimeSeries;
...
public class ExchangeRateProviderFactory {
    ...
    private static class Dijkstra {
        private final List<ExchangeRateTimeSeries> timeSeries = new ArrayList<>();

        private final Set<String> visited = new HashSet<>();
        private Set<String> unvisited = new HashSet<>();
        private final Map<String, ExchangeRateTimeSeries> predecessors = new HashMap<>();
