            ...
            for (int i = lines.length - 1; i >= 1; i--) {
                ...
                if (m.matches()) {
                    ...
                    if (i != (endOfLineOfSecurityTransactionBlock - 1)) {
                        String securityListKey = "security_" + trim(m.group("name")) + "_" +
                                baseCurrency + "_" +
                                (i + 1) + "_" +
                                endOfLineOfSecurityTransactionBlock;
                        context.put(securityListKey, m.group("isin"));
                    ...
                    for (String[] security : securityList) {
                        if (m.group("name").equals(security[1])) {
                            ...
                            String securityListKey = "security_" + trim(m.group("name")) + "_" +
                                    ...
                                    (i + 1) + "_" +
                                    endOfLineOfSecurityTransactionBlock;
                            context.put(securityListKey, security[0]);
                        }
                    }
                    endOfLineOfSecurityTransactionBlock = i;
                }
