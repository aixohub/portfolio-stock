...
public class RaiffeisenBankgruppePDFExtractor extends AbstractPDFExtractor {
    ...
    private void addDividendeTransaction() {
        ...
        pdfTransaction //
                ...
                .subject(() -> {
                    ...
                    accountTransaction.setType(Type.DIVIDENDS);
    ...
    private void addFeeTransaction() {
        ...
        pdfTransaction //
                ...
                .subject(() -> {
                    AccountTransaction accountTransaction = new AccountTransaction();
                    accountTransaction.setType(Type.FEES);
                    return accountTransaction;
                })
    ...
    private void addAccountStatementTransactions() {
        ...
        depositRemovalBlock.set(new Transaction<AccountTransaction>()
                ...
                .subject(() -> {
                    AccountTransaction accountTransaction = new AccountTransaction();
                    accountTransaction.setType(Type.REMOVAL);
                    return accountTransaction;
                })
        ...
        interestBlock.set(new Transaction<AccountTransaction>()
                ...
                .subject(() -> {
                    AccountTransaction accountTransaction = new AccountTransaction();
                    accountTransaction.setType(Type.INTEREST);
                    return accountTransaction;
                })
        ...
        taxesBlock.set(new Transaction<AccountTransaction>()
                ...
                .subject(() -> {
                    AccountTransaction accountTransaction = new AccountTransaction();
                    accountTransaction.setType(Type.TAXES);
                    return accountTransaction;
                })
