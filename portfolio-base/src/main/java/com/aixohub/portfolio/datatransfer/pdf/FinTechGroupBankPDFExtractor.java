...
import com.aixohub.portfolio.datatransfer.ExtrExchangeRate;
import com.aixohub.portfolio.datatransfer.ExtractorUtils;
...
import com.aixohub.portfolio.model.Transaction.Unit.Type;
...
import static com.aixohub.portfolio.datatransfer.ExtractorUtils.checkAndSetFee;
import static com.aixohub.portfolio.datatransfer.ExtractorUtils.checkAndSetGrossUnit;
import static com.aixohub.portfolio.datatransfer.ExtractorUtils.checkAndSetTax;
import static com.aixohub.portfolio.util.TextUtil.concatenate;
import static com.aixohub.portfolio.util.TextUtil.replaceMultipleBlanks;
        ...
        pdfTransaction //
                ...
                .oneOf( //
                        ...
                        section -> section //
                                ...
                                .match("^Nr\\.[\\d]+\\/[\\d]+[\\s]{1,}(Kauf|Verkauf)[ ]{1,}(?<name>.*) \\((?<isin>[A-Z]{2}[A-Z0-9]{9}[0-9])\\/(?<wkn>[A-Z0-9]{6})\\)$") //
        ...
        transaction //
                ...
                .assign((t, v) -> {
                    if (!type.getCurrentContext().getBoolean("negativeTax") && !type.getCurrentContext().getBoolean("negative")) {
                        ...
                        if (!tax.getCurrencyCode().equals(((BuySellEntry) t).getPortfolioTransaction().getCurrencyCode())) {
                ...
                // @formatter:off
                        ...
                        // @formatter:on
                .section("tax", "currency").optional() //
                .match("^Einbehaltene Kapitalertrags(s)?teuer[ ]{1,}\\-(?<tax>[\\.,\\d]+) (?<currency>[\\w]{3})$") //
        ...
        transaction //
                ...
                .assign((t, v) -> {
                    if (!type.getCurrentContext().getBoolean("negative")) {
                        ...
                        if (t instanceof com.aixohub.portfolio.model.Transaction tx)
