...
import com.aixohub.portfolio.datatransfer.DocumentContext;
import com.aixohub.portfolio.datatransfer.DuplicateSecurityException;
import com.aixohub.portfolio.datatransfer.Extractor.Item;
import com.aixohub.portfolio.datatransfer.ImportAction;
import com.aixohub.portfolio.datatransfer.ImportAction.Context;
import com.aixohub.portfolio.datatransfer.ImportAction.Status;
import com.aixohub.portfolio.model.Annotated;
import com.aixohub.portfolio.model.Security;
import com.aixohub.portfolio.model.TypedMap;
...
/* package */ final class PDFParser {
    ...
    /* package */ static class DocumentType {
        private final List<Pattern> mustInclude = new ArrayList<>();
        private final List<Pattern> mustNotInclude = new ArrayList<>();

        private final List<Block> blocks = new ArrayList<>();
        private final DocumentContext context = new DocumentContext();
         ...
         * @param lines   content lines of the file
         */
    ...
    /* package */static class Block {
        private final Pattern startsWith;
    ...
    /* package */static class Transaction<T> {
        ...
        private final List<Consumer<T>> concludes = new ArrayList<>();
