...
import com.aixohub.portfolio.snapshot.filter.ClientClassificationFilter;
import com.aixohub.portfolio.snapshot.filter.ClientSecurityFilter;
...
public class PerformanceIndex {
    ...
    public static PerformanceIndex forAccount(Client client, CurrencyConverter converter, Account account,
        ...
        Client pseudoClient = new PortfolioClientFilter(Collections.emptyList(), Collections.singletonList(account)).filter(client);
