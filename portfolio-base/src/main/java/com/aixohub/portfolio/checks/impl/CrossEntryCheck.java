...
public class CrossEntryCheck implements Check {
    ...
    private static class CheckImpl {
        ...
        private final List<AccountEntry> accountTransactions = new ArrayList<AccountEntry>();
        private final List<PortfolioEntry> portfolioTransactions = new ArrayList<PortfolioEntry>();
