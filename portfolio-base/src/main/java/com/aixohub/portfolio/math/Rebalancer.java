...
import com.aixohub.portfolio.money.MonetaryException;
...
public class Rebalancer {
    private final Map<InvestmentVehicle, Integer> investmentVehicleIndices;
    private final List<InvestmentVehicle> investmentVehicles;
    private final List<RebalancingConstraint> constraintsToSolve;
    ...
    public static class RebalancingConstraint {
        private final Map<InvestmentVehicle, Double> linearEquation;
    ...
    public static class RebalancingSolution {
        ...
        private final Map<InvestmentVehicle, Money> solution;
        private final Set<InvestmentVehicle> ambigousResults;
        private final Set<InvestmentVehicle> inexactResults;
    ...
    public static class FixedSumRebalancer {
        ...
        private final Rebalancer normalRebalancer;
