...
import static com.aixohub.portfolio.util.HolidayName.ALL_SAINTS_DAY;
import static com.aixohub.portfolio.util.HolidayName.ALL_SOULS_DAY;
import static com.aixohub.portfolio.util.HolidayName.ANZAC_DAY;
import static com.aixohub.portfolio.util.HolidayName.ASCENSION_DAY;
import static com.aixohub.portfolio.util.HolidayName.ASSUMPTION_DAY;
import static com.aixohub.portfolio.util.HolidayName.AUSTRALIA_DAY;
import static com.aixohub.portfolio.util.HolidayName.BERCHTOLDSTAG;
import static com.aixohub.portfolio.util.HolidayName.BOXING_DAY;
import static com.aixohub.portfolio.util.HolidayName.CARNIVAL;
import static com.aixohub.portfolio.util.HolidayName.CHILE;
import static com.aixohub.portfolio.util.HolidayName.CHILE_ARMY;
import static com.aixohub.portfolio.util.HolidayName.CHILE_EXTRA;
import static com.aixohub.portfolio.util.HolidayName.CHILE_NAVY_DAY;
import static com.aixohub.portfolio.util.HolidayName.CHRISTMAS;
import static com.aixohub.portfolio.util.HolidayName.CHRISTMAS_EVE;
import static com.aixohub.portfolio.util.HolidayName.CHRISTMAS_EVE_RUSSIA;
import static com.aixohub.portfolio.util.HolidayName.CIVIC_DAY;
import static com.aixohub.portfolio.util.HolidayName.COLUMBUS_DAY;
import static com.aixohub.portfolio.util.HolidayName.CORONATION;
import static com.aixohub.portfolio.util.HolidayName.CORPUS_CHRISTI;
import static com.aixohub.portfolio.util.HolidayName.DEFENDER_OF_THE_FATHERLAND_DAY;
import static com.aixohub.portfolio.util.HolidayName.EARLY_MAY_BANK_HOLIDAY;
import static com.aixohub.portfolio.util.HolidayName.EASTER_MONDAY;
import static com.aixohub.portfolio.util.HolidayName.EXTRA_HOLIDAY;
import static com.aixohub.portfolio.util.HolidayName.FAMILY_DAY;
import static com.aixohub.portfolio.util.HolidayName.FIRST_CHRISTMAS_DAY;
import static com.aixohub.portfolio.util.HolidayName.GOOD_FRIDAY;
import static com.aixohub.portfolio.util.HolidayName.HURRICANE_SANDY;
import static com.aixohub.portfolio.util.HolidayName.INDEPENDENCE;
import static com.aixohub.portfolio.util.HolidayName.INDIGENOUS_PEOPLE;
import static com.aixohub.portfolio.util.HolidayName.INMACULATE_CONCEPTION;
import static com.aixohub.portfolio.util.HolidayName.INTERNATION_WOMENS_DAY;
import static com.aixohub.portfolio.util.HolidayName.JUNETEENTH;
import static com.aixohub.portfolio.util.HolidayName.KINGS_BIRTHDAY;
import static com.aixohub.portfolio.util.HolidayName.LABOUR_DAY;
import static com.aixohub.portfolio.util.HolidayName.MARTIN_LUTHER_KING;
import static com.aixohub.portfolio.util.HolidayName.MEMORIAL;
import static com.aixohub.portfolio.util.HolidayName.MILLENNIUM;
import static com.aixohub.portfolio.util.HolidayName.NATION_DAY;
import static com.aixohub.portfolio.util.HolidayName.NEW_YEAR;
import static com.aixohub.portfolio.util.HolidayName.NEW_YEARS_EVE;
import static com.aixohub.portfolio.util.HolidayName.NEW_YEAR_HOLIDAY;
import static com.aixohub.portfolio.util.HolidayName.PATRON_DAY;
import static com.aixohub.portfolio.util.HolidayName.REFORMATION_DAY;
import static com.aixohub.portfolio.util.HolidayName.REPENTANCE_AND_PRAYER;
import static com.aixohub.portfolio.util.HolidayName.REPUBLIC_PROCLAMATION_DAY;
import static com.aixohub.portfolio.util.HolidayName.ROYAL_JUBILEE;
import static com.aixohub.portfolio.util.HolidayName.ROYAL_WEDDING;
import static com.aixohub.portfolio.util.HolidayName.SAINT_PETER_PAUL;
import static com.aixohub.portfolio.util.HolidayName.SAINT_STEPHEN;
import static com.aixohub.portfolio.util.HolidayName.SECOND_CHRISTMAS_DAY;
import static com.aixohub.portfolio.util.HolidayName.SPRING_MAY_BANK_HOLIDAY;
import static com.aixohub.portfolio.util.HolidayName.STATE_FUNERAL;
import static com.aixohub.portfolio.util.HolidayName.SUMMER_BANK_HOLIDAY;
import static com.aixohub.portfolio.util.HolidayName.TERRORIST_ATTACKS;
import static com.aixohub.portfolio.util.HolidayName.THANKSGIVING;
import static com.aixohub.portfolio.util.HolidayName.TIRADENTES_DAY;
import static com.aixohub.portfolio.util.HolidayName.UNIFICATION_GERMANY;
import static com.aixohub.portfolio.util.HolidayName.UNITY_DAY;
import static com.aixohub.portfolio.util.HolidayName.VICTORIA_DAY;
import static com.aixohub.portfolio.util.HolidayName.VICTORY_DAY;
import static com.aixohub.portfolio.util.HolidayName.VIRGIN_OF_CARMEN;
import static com.aixohub.portfolio.util.HolidayName.WASHINGTONS_BIRTHDAY;
import static com.aixohub.portfolio.util.HolidayName.WHIT_MONDAY;
import static com.aixohub.portfolio.util.HolidayType.easter;
import static com.aixohub.portfolio.util.HolidayType.fixed;
import static com.aixohub.portfolio.util.HolidayType.weekday;
