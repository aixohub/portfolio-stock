...
import com.aixohub.portfolio.model.AttributeType.Converter;
import com.aixohub.portfolio.model.Classification.Assignment;
import com.aixohub.portfolio.model.ClientFactory.ClientPersister;
import com.aixohub.portfolio.model.ConfigurationSet.Configuration;
import com.aixohub.portfolio.model.SecurityEvent.DividendEvent;
import com.aixohub.portfolio.model.proto.v1.PAccount;
import com.aixohub.portfolio.model.proto.v1.PAnyValue;
import com.aixohub.portfolio.model.proto.v1.PAttributeType;
import com.aixohub.portfolio.model.proto.v1.PBookmark;
import com.aixohub.portfolio.model.proto.v1.PClient;
import com.aixohub.portfolio.model.proto.v1.PConfigurationSet;
import com.aixohub.portfolio.model.proto.v1.PDashboard;
import com.aixohub.portfolio.model.proto.v1.PFullHistoricalPrice;
import com.aixohub.portfolio.model.proto.v1.PHistoricalPrice;
import com.aixohub.portfolio.model.proto.v1.PInvestmentPlan;
import com.aixohub.portfolio.model.proto.v1.PInvestmentPlan.Type;
import com.aixohub.portfolio.model.proto.v1.PKeyValue;
import com.aixohub.portfolio.model.proto.v1.PMap;
import com.aixohub.portfolio.model.proto.v1.PPortfolio;
import com.aixohub.portfolio.model.proto.v1.PSecurity;
import com.aixohub.portfolio.model.proto.v1.PSecurityEvent;
import com.aixohub.portfolio.model.proto.v1.PSettings;
import com.aixohub.portfolio.model.proto.v1.PTaxonomy;
import com.aixohub.portfolio.model.proto.v1.PTransaction;
import com.aixohub.portfolio.model.proto.v1.PTransactionUnit;
import com.aixohub.portfolio.model.proto.v1.PWatchlist;
...
import static com.aixohub.portfolio.util.CollectorsUtil.toMutableList;
import static com.aixohub.portfolio.util.ProtobufUtil.asDecimalValue;
import static com.aixohub.portfolio.util.ProtobufUtil.asTimestamp;
import static com.aixohub.portfolio.util.ProtobufUtil.asUpdatedAtTimestamp;
import static com.aixohub.portfolio.util.ProtobufUtil.fromDecimalValue;
import static com.aixohub.portfolio.util.ProtobufUtil.fromTimestamp;
import static com.aixohub.portfolio.util.ProtobufUtil.fromUpdatedAtTimestamp;
...
/* package */ class ProtobufWriter implements ClientPersister {
    ...
    private static class Lookup {
        private final Map<String, Security> uuid2security = new HashMap<>();

        private final Map<String, Portfolio> uuid2portfolio = new HashMap<>();

        private final Map<String, Account> uuid2account = new HashMap<>();
