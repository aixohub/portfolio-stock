...
import com.aixohub.portfolio.online.impl.variableurl.Factory;
import com.aixohub.portfolio.online.impl.variableurl.urls.VariableURL;
import com.aixohub.portfolio.util.OnlineHelper;
...
import com.aixohub.portfolio.util.WebAccess.WebAccessException;
...
public class HTMLTableQuoteFeed implements QuoteFeed {
     ...
     *
     * @param args list of URLs and/or local files
     */
    ...
    protected void doLoad(String source, PrintWriter writer) throws IOException {
        ...
        if (source.startsWith("http")) {
            ...
            try (Scanner scanner = new Scanner(new File(source), StandardCharsets.UTF_8)) {
    ...
    protected static class TimeColumn extends Column {
        private final DateTimeFormatter[] formatters = new DateTimeFormatter[]{DateTimeFormatter.ISO_LOCAL_TIME};
