...
import com.aixohub.portfolio.util.RateLimitExceededException;
...
import static com.aixohub.portfolio.online.impl.YahooHelper.asPrice;
...
public class AlphavantageQuoteFeed implements QuoteFeed {
     ...
     */
    private static final RateLimiter rateLimiter = RateLimiter.create((5 - .5) / 60d);
